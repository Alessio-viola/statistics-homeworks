...
namespace Q1b
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // Simulate the score trajectories for each system
            for (int i = 0; i < M; i++)
            {
                ...
                for (int j = 0; j < N; j++)
                {
                    ...
                    {
                        scoreTrajectories[i][j] = -1; // System is penetrated
                    }
                    else
                    {
                        scoreTrajectories[i][j] = 1; // System is protected
                    }

                    // Aggiorna la cumulative frequency
            ...
            // Initialize the Chart control for cumulative frequency (f)
